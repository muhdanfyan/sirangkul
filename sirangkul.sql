...
--
-- Host: localhost:3306
-- Generation Time: Mar 04, 2026 at 12:12 PM
...
INSERT INTO `approval_workflows` (`id`, `proposal_id`, `approver_id`, `status`, `notes`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `feedback` (`id`, `user_id`, `proposal_id`, `message`, `created_at`) VALUES
...
INSERT INTO `payments` (`id`, `proposal_id`, `amount`, `recipient_name`, `recipient_account`, `bank_name`, `payment_method`, `payment_reference`, `payment_proof_url`, `payment_proof_file`, `payment_date`, `status`, `notes`, `admin_notes`, `processed_at`, `completed_at`, `processed_by`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `proposals` (`id`, `user_id`, `rkam_id`, `title`, `description`, `jumlah_pengajuan`, `status`, `submitted_at`, `verified_at`, `verified_by`, `approved_at`, `approved_by`, `rejected_at`, `rejected_by`, `rejection_reason`, `final_approved_at`, `final_approved_by`, `completed_at`, `requires_committee_approval`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `proposal_attachments` (`id`, `proposal_id`, `file_name`, `file_path`, `created_at`) VALUES
...
INSERT INTO `rkam` (`id`, `kategori`, `item_name`, `pagu`, `tahun_anggaran`, `deskripsi`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `users` (`id`, `email`, `password`, `full_name`, `role`, `created_at`, `updated_at`, `status`) VALUES
...
ALTER TABLE `approval_workflows`
  ADD PRIMARY KEY (`id`),
  ADD KEY `approval_workflows_proposal_id_foreign` (`proposal_id`),
...
ALTER TABLE `feedback`
  ...
  ADD KEY `feedback_proposal_id_foreign` (`proposal_id`);
...
ALTER TABLE `payments`
  ADD PRIMARY KEY (`id`),
  ADD KEY `payments_proposal_id_foreign` (`proposal_id`),
...
ALTER TABLE `proposals`
  ...
  ADD KEY `proposals_rkam_id_foreign` (`rkam_id`),
  ADD KEY `proposals_verified_by_foreign` (`verified_by`),
  ADD KEY `proposals_approved_by_foreign` (`approved_by`),
  ADD KEY `proposals_rejected_by_foreign` (`rejected_by`),
  ADD KEY `proposals_final_approved_by_foreign` (`final_approved_by`);
...
ALTER TABLE `proposal_attachments`
  ADD PRIMARY KEY (`id`),
  ADD KEY `proposal_attachments_proposal_id_foreign` (`proposal_id`);

--
-- Indexes for table `rkam`
--
ALTER TABLE `rkam`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `approval_workflows`
  ADD CONSTRAINT `approval_workflows_approver_id_foreign` FOREIGN KEY (`approver_id`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `approval_workflows_proposal_id_foreign` FOREIGN KEY (`proposal_id`) REFERENCES `proposals` (`id`);
...
--
ALTER TABLE `feedback`
  ADD CONSTRAINT `feedback_proposal_id_foreign` FOREIGN KEY (`proposal_id`) REFERENCES `proposals` (`id`),
...
ALTER TABLE `payments`
  ...
  ADD CONSTRAINT `payments_proposal_id_foreign` FOREIGN KEY (`proposal_id`) REFERENCES `proposals` (`id`);

--
-- Constraints for table `proposals`
--
ALTER TABLE `proposals`
  ADD CONSTRAINT `proposals_approved_by_foreign` FOREIGN KEY (`approved_by`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `proposals_final_approved_by_foreign` FOREIGN KEY (`final_approved_by`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `proposals_rejected_by_foreign` FOREIGN KEY (`rejected_by`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `proposals_rkam_id_foreign` FOREIGN KEY (`rkam_id`) REFERENCES `rkam` (`id`),
  ADD CONSTRAINT `proposals_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `proposals_verified_by_foreign` FOREIGN KEY (`verified_by`) REFERENCES `users` (`id`) ON DELETE SET NULL;

--
-- Constraints for table `proposal_attachments`
--
ALTER TABLE `proposal_attachments`
  ADD CONSTRAINT `proposal_attachments_proposal_id_foreign` FOREIGN KEY (`proposal_id`) REFERENCES `proposals` (`id`);
COMMIT;
